...
public class DisplayCalendarInLabel extends JFrame {
     ...
     */
    private DisplayCalendarInLabel(GregorianCalendar date) {
        ...
        this.setTitle(String.format(
                "%s %s %01d, %d",
                weekday_symbols[date.get(Calendar.DAY_OF_WEEK)],
                month_symbols[date.get(Calendar.MONTH)],
        ...
        int days_in_month = date.getActualMaximum(Calendar.DAY_OF_MONTH);
