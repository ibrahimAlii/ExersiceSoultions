...
public class KnightsTour extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
    ...
    public KnightsTour(int a, int b) {
    ...
    public static void main (String[] str) {
        ...
        JFrame frame = new KnightsTour(m, n);
        frame.setSize(m, n);
