...
public class FullClock extends JPanel {
    private int hour;
    private int minute;
    private int second;
     ...
     */
    public FullClock(int hour, int minute, int second) {
        this.hour = hour;
        this.minute = minute;
        this.second = second;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        // TODO: 06/03/2018 separate loop to 4 loops to get right ticks
        for (int i = 0; i < 360; i++) {
            int x = (int) (clockRadius * Math.sin(i)) + xCenter;
            int y = (int) (clockRadius * Math.cos(i)) + yCenter;
